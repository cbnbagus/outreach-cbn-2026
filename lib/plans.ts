...
export const PLAN_CONFIGS: Record<PlanTier, PlanConfig> = {
  ...
  starter: {
    ...
    highlights: [
      ...
      "\ud83d\udd12 AI crisis escalation to pastoral team (Growth plan)",
  ...
  growth: {
    ...
    highlights: [
      ...
      "\u26a1 AI crisis detection & instant WhatsApp escalation to your pastoral team",
      "Call integration available ($49 setup)",
  ...
  enterprise: {
    ...
    highlights: [
      ...
      "\u26a1 AI crisis detection & instant WhatsApp escalation to your pastoral team",
      "AI trained on your doctrine & theology",
      "API & webhook access",
      "Call integration included",
...
export const FEATURE_LABELS: Record<FeatureKey, string> = {
  ...
  escalationTriggers:    "AI Crisis Detection & WhatsApp Escalation",
  ...
  customBranding:        "AI Trained on Your Doctrine",
